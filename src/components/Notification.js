...
const Notification = () => {
  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      try {
        ...
        const response = await axios.get(`https://outlier-and-da-backend.onrender.com/api/users/notifications/${userId}`, {
          headers: {
  ...
  const removeNotification = async (id) => {
    try {
      ...
      await axios.delete(`https://outlier-and-da-backend.onrender.com/api/users/notifications/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const handleNotificationClick = async (notification) => {
    ...
    try {
      ...
      const response = await axios.get(`https://outlier-and-da-backend.onrender.com/api/orders/${notification.orderId}/${notification.userId}`, {
